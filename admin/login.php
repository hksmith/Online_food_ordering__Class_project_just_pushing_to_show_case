        ...
        <div class="login">
            ...
            <br>
             ...
             <form class="text-center" action="" method="POST">
                <input class="text-center" type="text" name="username" placeholder="Enter Username">
                <br><br>
                <input class="text-center" type="password" name="password" placeholder="Enter Password">
                <br><br>
