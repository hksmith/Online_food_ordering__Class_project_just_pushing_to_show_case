        ...
        <div class="wrapper">
                        ...
                        <td style="padding: 0; margin: 0;">
                            <?php
                                ...
                                if($current_image != "")
                                {
                                    ...
                                    <img src="<?php echo SITEURL; ?>images/category/<?php echo $current_image; ?>" alt="" style="width: 100%; height: auto;">
            ...
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    {
                        $_SESSION['update'] = "<div class='error'> Failled to update category</div>";
                        header('location:'.SITEURL.'admin/manage-category.php');
                    }
                }
