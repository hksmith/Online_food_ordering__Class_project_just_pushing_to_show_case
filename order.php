<?php 
    ...
    include('partials-front/loginU-check.php');
...
<?php
    ...
    if(isset($_GET['food_id']))
    {
        ...
        $sql3 = "SELECT * FROM tbl_users WHERE ";
        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="email" name="email" placeholder="Your Emial" class="input-responsive" required>
